        ...
        <div class="hero-install">
          <label class="install-label">
            <div class="install-input-wrapper">
              <input type="text" value="pnpm add @schepta/core" readonly class="install-input" :id="hero.installCommandId" />
              <div class="install-copy-overlay" :data-install-id="hero.installCommandId"></div>
              <span class="install-icon-leading">
                <TerminalIcon :size="24" class="install-icon" />
              </span>
              <span class="install-icon-trailing">
                <button type="button" class="install-copy-button" :data-install-id="hero.installCommandId" :aria-label="hero.copyButtonLabel">
