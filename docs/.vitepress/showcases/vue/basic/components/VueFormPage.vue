<template>
  <div style="padding: 2rem; background: var(--schepta-bg); border-radius: 8px; margin: 1rem 0;">
    <div style="color: var(--schepta-brand); margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
