          ...
          '/en-US/concepts/': [
            {
              ...
              items: [
                ...
                { text: '08. Creating a Factory', link: '/en-US/concepts/08-create-factory' },
                { text: '09. Accessibility', link: '/en-US/concepts/09-accessibility' },
              ],
            },
          ],
          '/en-US/showcases/': [
          ...
          '/pt-BR/concepts/': [
            {
              ...
              items: [
                ...
                { text: '08. Criando uma Factory', link: '/pt-BR/concepts/08-create-factory' },
                { text: '09. Acessibilidade', link: '/pt-BR/concepts/09-accessibility' },
              ],
            },
          ],
          '/pt-BR/showcases/': [
          ...
          '/es-ES/concepts/': [
            {
              ...
              items: [
                ...
                { text: '08. Creando una Factory', link: '/es-ES/concepts/08-create-factory' },
                { text: '09. Accesibilidad', link: '/es-ES/concepts/09-accessibility' },
              ],
            },
          ],
          '/es-ES/showcases/': [
