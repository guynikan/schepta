...
const navigationItems = [
  { path: "/basic", label: "Basic Showcase", icon: <FaReact /> },
  { path: "/chakra-ui", label: "Chakra UI Showcase", icon: <SiChakraui /> },
  { path: "/material-ui", label: "Material UI Showcase", icon: <SiMui /> },
];
